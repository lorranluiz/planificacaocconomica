...
document.getElementById('processarEExibirHelloWorld').addEventListener('click', processarEExibirHelloWorld);
...
function processarEExibirHelloWorld() {
    ...
    fetch('microservices/helloMicroService/bridge/processarEExibirHelloWorld')
        .then(response => response.json())
        .then(data => {

            callbackProcessarEExibirHelloWorld(data);
...
function callbackProcessarEExibirHelloWorld(data) {
