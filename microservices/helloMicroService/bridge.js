...
class Bridge {
  ...
  processarEExibirHelloWorld(req, res) {
    exec('python ./microservices/helloMicroService/py/processarEExibirHelloWorld.py', (error, stdout, stderr) => {
  ...
  processarOutraFuncao(req, res) {
    exec('python ./microservices/helloMicroService/py/processarOutraFuncao.py', (error, stdout, stderr) => {
  ...
  //#region Mapeamento das Rotas pra acessar essas Funções
   constructor() {
    ...
    //Rota da função processarOutraFuncao() deste microsserviço
    this.processarOutraFuncaoRoute = {
      routePath: '/helloMicroService/bridge/processarOutraFuncao', 
      callback: (req, res) => {
        const microservicesBridges = require('../microservicesBridges.js');
        microservicesBridges.helloMicroService.processarOutraFuncao(req, res);
      }
    };
...
// Criar instância desse microsserviço e exportá-lo
